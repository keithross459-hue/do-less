...
import { Bot, Activity, Zap, Shield, Cpu, MessageSquare, ChevronRight, X, Maximize2, Terminal } from "lucide-react";
...
export default function DesktopOverlay() {
  ...
  return (
    <div className="h-screen w-full flex flex-col p-4 bg-transparent select-none">
      
      {/* Floating Orb / Assistant Status */}
      <motion.div 
      ...
      >
        ...
        <div className="flex-1">
          ...
          <p className="text-[10px] text-primary font-bold animate-pulse">System Online // All Nodes Active</p>
        </div>
      ...
      <div className="mt-4 pt-4 border-t border-white/10 flex items-center justify-around">
        ...
        <button className="flex flex-col items-center gap-1 group">
          <div className="p-2.5 rounded-full bg-white/5 border border-white/10 group-hover:bg-primary/20 group-hover:border-primary/40 transition-all shadow-lg">
            <Shield className="w-4 h-4 text-zinc-400 group-hover:text-primary" />
          </div>
          <span className="text-[8px] font-bold text-zinc-600 uppercase group-hover:text-primary">Guard</span>
        </button>
      </div>
